...
/**
 * Class CronMailSettingsForm
 * @package Drupal\test_module\Form
 */
class CronMailSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'cron_mail_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['simple_sitemap_settings']['#prefix'] = $this->t('Test');
